  ...
  ht: {
    ...
    faq: {
      ...
      items: [
        ...
        { q: "DivorceGPT sử dụng công nghệ gì?", a: "DivorceGPT sử dụng Claude AI của Anthropic thông qua API thương mại. Theo điều khoản API của Anthropic, dữ liệu đầu vào của bạn không được sử dụng để huấn luyện mô hình AI và tự động xóa trong vài ngày. June Guided Solutions, LLC (công ty đứng sau DivorceGPT) không lưu giữ bất kỳ lịch sử trò chuyện hoặc dữ liệu hội thoại nào. Nếu bạn cần hỗ trợ, bạn phải cung cấp ảnh chụp màn hình cuộc trò chuyện — chúng tôi không có cách nào để khôi phục nó." },
