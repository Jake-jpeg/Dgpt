...
const config: StateConfig = {
  ...
  abbreviation: 'NY',
  phase1Fields: [
    'plaintiffName', 'defendantName', 'qualifyingCounty', 'qualifyingParty',
    'qualifyingAddress', 'plaintiffPhone', 'plaintiffAddress', 'defendantAddress', 'ceremonyType'
  ],
  phase2Fields: [
    'indexNumber', 'summonsDate', 'marriageDate', 'marriageCity',
    'marriageCounty', 'marriageState', 'breakdownDate'
  ],
  phase3Fields: [
    'judgmentEntryDate', 'defendantCurrentAddress'
  ],
  breakdownMonths: 6,
  addressCopyRules: [
    {
      sourceField: 'plaintiffAddress',
      targetField: 'qualifyingAddress',
      condition: (data) => data.qualifyingParty === 'plaintiff',
    },
    {
      sourceField: 'qualifyingAddress',
      targetField: 'plaintiffAddress',
      condition: (data) => data.qualifyingParty === 'plaintiff',
    },
  ],
  systemPrompt: `
