  ...
  en: {
    ...
    qualify: {
      ...
      fields: {
        ...
        summonsDate: { label: "Summons Date", desc: "Date on UD-1" },
  ...
  es: {
    ...
    qualify: {
      ...
      fields: {
        ...
        summonsDate: { label: "Fecha de Citación", desc: "Fecha en UD-1" },
  ...
  zh: {
    ...
    qualify: {
      ...
      fields: {
        ...
        summonsDate: { label: "传票日期", desc: "UD-1上的日期" },
  ...
  ko: {
    ...
    qualify: {
      ...
      fields: {
        ...
        summonsDate: { label: "소환장 날짜", desc: "UD-1의 날짜" },
  ...
  ru: {
    ...
    qualify: {
      ...
      fields: {
        ...
        summonsDate: { label: "Дата повестки", desc: "Дата на UD-1" },
