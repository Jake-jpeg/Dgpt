  ...
  en: {
    ...
    faq: {
      ...
      items: [
        ...
        { q: "What technology powers DivorceGPT?", a: "DivorceGPT uses Claude AI combined with custom legal document guardrails for Nevada filings. Your conversations are not stored." },
  ...
  es: {
    ...
    faq: {
      ...
      items: [
        ...
        { q: "¿Qué tecnología utiliza DivorceGPT?", a: "DivorceGPT usa inteligencia artificial Claude AI con protecciones para documentos legales de Nevada. Sus conversaciones no se almacenan." },
  ...
  zh: {
    ...
    faq: {
      ...
      items: [
        ...
        { q: "DivorceGPT 使用什么技术？", a: "DivorceGPT 使用 Claude AI 结合内华达州法律文件保护机制。您的对话不会被存储。" },
  ...
  ko: {
    ...
    faq: {
      ...
      items: [
        ...
        { q: "DivorceGPT는 어떤 기술을 사용하나요?", a: "DivorceGPT는 네바다주 법률 문서 보호 기능과 결합된 Claude AI를 사용합니다. 대화는 저장되지 않습니다." },
  ...
  ht: {
    ...
    faq: {
      ...
      items: [
        ...
        { q: "Anong teknolohiya ang ginagamit ng DivorceGPT?", a: "Gumagamit ang DivorceGPT ng Claude AI na may legal document safeguards para sa Nevada filings. Hindi sine-save ang iyong mga usapan." },
