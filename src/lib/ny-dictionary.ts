...
export const dictionary = {
  ...
  es: {
    ...
    howItWorks: {
      ...
      steps: [
        ...
        { title: "Pagar $99", desc: "Pago único. Sin cargos ocultos. Sin suscripciones." },
  ...
  ko: {
    ...
    qualify: {
      ...
      disclosure: {
        ...
        continueButton: "DivorceGPT로 계속하기 ($99)"
      },
      fields: {
  ...
  ru: {
    hero: {
      ...
      fee: "Разовый платеж $99 • Без скрытых комиссий"
    },
    howToUse: {
    ...
    howItWorks: {
      ...
      steps: [
        ...
        { title: "Оплата $99", desc: "Разовый платеж. Никаких подписок." },
  ...
  ht: {
    hero: {
      ...
      fee: "Frè $99 yon sèl fwa • Pa gen lòt frè kache"
    },
    howToUse: {
