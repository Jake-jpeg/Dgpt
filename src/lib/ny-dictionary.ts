...
export const dictionary = {
  ...
  es: {
    hero: {
      ...
      fee: "Tarifa única de $250 • Sin costos ocultos"
    },
    howToUse: {
      title: "Cómo Usar",
    ...
    howItWorks: {
      ...
      steps: [
        ...
        { title: "Pagar $250", desc: "Pago único. Sin cargos ocultos. Sin suscripciones." },
  ...
  zh: {
    ...
    qualify: {
      ...
      disclosure: {
        ...
        continueButton: "继续使用 DivorceGPT ($250)"
      },
      fields: {
  ...
  ko: {
    ...
    qualify: {
      ...
      disclosure: {
        ...
        continueButton: "DivorceGPT로 계속하기 ($250)"
      },
      fields: {
  ...
  ru: {
    hero: {
      ...
      fee: "Разовый платеж $250 • Без скрытых комиссий"
    },
    howToUse: {
    ...
    howItWorks: {
      ...
      steps: [
        ...
        { title: "Оплата $250", desc: "Разовый платеж. Никаких подписок." },
  ...
  ht: {
    hero: {
      ...
      fee: "Frè $250 yon sèl fwa • Pa gen lòt frè kache"
    },
    howToUse: {
