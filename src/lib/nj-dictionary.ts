  ...
  en: {
    ...
    qualify: {
      ...
      questions: {
        ...
        cooperation: { q: "Will the other spouse cooperate with signing or service of papers?", d: "Spouse will sign Acknowledgment of Service before a notary." },
  ...
  es: {
    ...
    qualify: {
      ...
      questions: {
        ...
        uncontested: { q: "¿El divorcio es no contestado y ambos cónyuges están de acuerdo en terminar el matrimonio?", d: "Ambas partes quieren el divorcio y están de acuerdo en todos los términos." },
        cooperation: { q: "¿Cooperará el otro cónyuge con la firma o servicio de documentos?", d: "El cónyuge firmará el Reconocimiento de Servicio ante un notario." },
  ...
  zh: {
    ...
    qualify: {
      ...
      questions: {
        ...
        uncontested: { q: "离婚是否无争议，双方是否都同意结束婚姻？", d: "双方都想离婚并同意所有条款。" },
        cooperation: { q: "另一方配偶是否愿意配合签署或送达文件？", d: "配偶将在公证人面前签署送达确认书。" },
  ...
  ko: {
    ...
    qualify: {
      ...
      questions: {
        ...
        uncontested: { q: "이혼이 무분쟁이며 양측 모두 결혼 종료에 동의하나요?", d: "양측 모두 이혼을 원하고 모든 조건에 동의합니다." },
        cooperation: { q: "상대 배우자가 서류 서명이나 송달에 협조할 것인가요?", d: "배우자가 공증인 앞에서 송달 확인서에 서명할 것입니다." },
  ...
  ru: {
    ...
    qualify: {
      ...
      questions: {
        ...
        uncontested: { q: "Является ли развод бесспорным и оба ли супруга согласны на прекращение брака?", d: "Обе стороны хотят развода и согласны по всем условиям." },
        cooperation: { q: "Будет ли другой супруг сотрудничать при подписании или вручении документов?", d: "Супруг подпишет Подтверждение вручения перед нотариусом." },
  ...
  ht: {
    ...
    qualify: {
      ...
      questions: {
        ...
        cooperation: { q: "Èske lòt konjwen an ap kowopere pou siyen oswa resevwa papye yo?", d: "Konjwen an pral siyen Rekonesans Sèvis devan yon notè." },
