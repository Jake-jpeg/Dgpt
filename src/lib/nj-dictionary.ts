...
export const njDictionary: Record<Locale, any> = {
  en: {
    hero: {
      ...
      fee: "$250 one-time fee • No hidden costs"
    },
    howToUse: {
      title: "How to Use",
    ...
    qualify: {
      ...
      disclosure: {
        ...
        continueButton: "Continue with DivorceGPT ($250)"
      },
      fields: {
  ...
  es: {
    hero: {
      ...
      fee: "$250 pago único • Sin costos ocultos"
    },
    howToUse: {
      title: "Cómo Usar",
    ...
    howItWorks: {
      ...
      steps: [
        ...
        { title: "Pague $250", desc: "Pago único. Sin tarifas ocultas. Sin suscripciones." },
    ...
    qualify: {
      ...
      disclosure: {
        ...
        continueButton: "Continuar con DivorceGPT ($250)"
      },
      fields: {
  ...
  zh: {
    ...
    howItWorks: {
      ...
      steps: [
        ...
        { title: "支付$250", desc: "一次性付款。无隐藏费用。无订阅。" },
    ...
    qualify: {
      ...
      disclosure: {
        ...
        continueButton: "继续使用DivorceGPT（$250）"
      },
      fields: {
  ...
  ko: {
    ...
    howItWorks: {
      ...
      steps: [
        ...
        { title: "$250 결제", desc: "일회성 결제. 숨겨진 수수료 없음. 구독 없음." },
    ...
    qualify: {
      ...
      disclosure: {
        ...
        continueButton: "DivorceGPT 계속 사용($250)"
      },
      fields: {
  ...
  ru: {
    hero: {
      ...
      fee: "$250 единоразовый платёж • Без скрытых расходов"
    },
    howToUse: {
    ...
    howItWorks: {
      ...
      steps: [
        ...
        { title: "Оплатите $250", desc: "Единоразовый платёж. Без скрытых сборов. Без подписок." },
    ...
    qualify: {
      ...
      disclosure: {
        ...
        continueButton: "Продолжить с DivorceGPT ($250)"
      },
      fields: {
  ...
  ht: {
    hero: {
      ...
      fee: "$250 peman yon sèl fwa • Pa gen frè kache"
    },
    howToUse: {
    ...
    howItWorks: {
      ...
      steps: [
        ...
        { title: "Peye $250", desc: "Peman yon sèl fwa. Pa gen frè kache. Pa gen abònman." },
    ...
    qualify: {
      ...
      disclosure: {
        ...
        continueButton: "Kontinye ak DivorceGPT ($250)"
      },
      fields: {
