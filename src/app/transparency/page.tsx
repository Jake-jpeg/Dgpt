    ...
    <>
      ...
      <div className="min-h-screen bg-zinc-50">
        ...
        <article className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-16">
          ...
          {/* E-E-A-T Callout */}
          <div className="bg-[#1a365d] text-white rounded-lg p-6 my-10">
            <p className="text-sm leading-relaxed">
              <strong className="text-[#c59d5f]">A note on E-E-A-T:</strong>{" "}
              Google&apos;s quality guidelines for Your Money or Your Life (YMYL) content require demonstrated Experience, Expertise, Authoritativeness, and Trustworthiness. This post — and this product — are authored by a licensed attorney with active trial experience in the jurisdiction the product serves, who personally designed and coded the compliance architecture described above. If that doesn&apos;t satisfy the standard, I&apos;m not sure what does.
            </p>
          </div>
