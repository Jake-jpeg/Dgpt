      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-[#1a365d] via-[#1e3a5f] to-[#234876] pt-16 pb-32">
        ...
        <div className="relative mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mt-4 text-sm text-zinc-400">
            Korean speakers: <Link href="/ko/nj" className="underline hover:text-white transition">한국어로 보기 →</Link>
          </p>
        ...
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 space-y-4">
            {[
              ...
              { q: "Does DivorceGPT support Korean?", a: "Yes. DivorceGPT operates in Korean and English. Use the 한국어 / EN switch at the top of the page to work in Korean. All court filings are generated in English as required by New Jersey courts. See our Language Support page for details." },
