        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div><h1 className="text-lg font-semibold text-zinc-900" translate="no">DivorceGPT</h1><p className="text-xs text-zinc-500">by <a href="https://juneguidedsolutions.com" className="underline hover:text-[#1a365d]">June Guided Solutions, LLC</a></p></div>
            </div>
            <LanguageToggle />
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="order-1">
              ...
              <p className="mt-5 text-lg text-zinc-300 leading-relaxed max-w-xl">
                Prepare your divorce forms with an automated AI clerk — $500. A self-guided tool for individuals in simple, uncontested cases.
              </p>
      ...
      <section id="pricing" className="py-24 bg-white">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="mt-4 text-lg text-zinc-600">Simple case? Do it yourself for free, or let AI handle the paperwork for $500.</p>
          </div>
          <div className="grid gap-8 md:grid-cols-3 max-w-6xl mx-auto">
            ...
            {/* Card 2: AI-Assisted $500 — blue/gold FEATURED */}
            <div className="relative rounded-2xl bg-gradient-to-b from-[#1a365d] to-[#234876] p-8 text-white shadow-xl shadow-[#1a365d]/20 ring-2 ring-[#c59d5f] md:-translate-y-4 flex flex-col min-h-[620px]">
              ...
              <div className="mt-3"><span className="text-4xl font-bold text-[#c59d5f]">$500</span></div>
      ...
      <section id="states" className="py-24 bg-zinc-50">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="mt-4 text-lg text-zinc-600">$500 for a complete court-ready document packet. Eligibility check required.</p>
          </div>
            ...
            {states.map((s) => (
              <Link key={s.code} href={s.live ? `/${s.code}` : s.href} className={`group relative rounded-2xl p-8 transition-all duration-300 ${s.live ? "bg-gradient-to-b from-[#1a365d] to-[#234876] text-white shadow-xl shadow-[#1a365d]/20 hover:shadow-2xl hover:-translate-y-1" : "bg-white text-zinc-900 ring-1 ring-zinc-200 hover:ring-zinc-300 hover:shadow-lg"}`}>
                ...
                <div className={`mt-6 flex items-center justify-between border-t pt-4 ${s.live ? "border-white/10" : "border-zinc-200"}`}>
                  ...
                  {s.live && <span className="text-sm font-semibold text-[#c59d5f]">$500</span>}
                </div>
        ...
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-8 md:grid-cols-2 max-w-4xl mx-auto">
            {[
              ...
              { icon: "🤖", title: "AI-Assisted ($500)", steps: ["Select your state & qualify", "AI guides you through every field", "Forms prepared in plain language", "Download & file with the court"] },
            ].map((p, i) => (
          ...
          <div className="grid gap-8 md:grid-cols-4">
            ...
            <div>
              ...
              <div className="space-y-2 text-sm">
                <Link href="#states" className="block text-zinc-400 hover:text-[#c59d5f] transition">AI-Assisted Divorce ($500)</Link>
              </div>
            </div>
            <div>
