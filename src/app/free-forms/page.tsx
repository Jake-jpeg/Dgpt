    ...
    <div className="min-h-screen bg-zinc-50">
      ...
      <main className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 rounded-2xl bg-gradient-to-b from-[#1a365d] to-[#234876] p-8 text-center">
          ...
          <p className="mt-2 text-sm text-zinc-300">DivorceGPT walks you through every field in plain language and prepares your complete court-ready packet for $500.</p>
          <Link href="/#states" className="mt-6 inline-flex items-center gap-2 rounded-full bg-[#c59d5f] px-8 py-3 text-sm font-semibold text-white shadow-lg shadow-[#c59d5f]/30 hover:bg-[#d4ac6e] transition">Get AI Assistance — $500 →</Link>
        </div>
