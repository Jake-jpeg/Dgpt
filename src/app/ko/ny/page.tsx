...
export const metadata: Metadata = {
  title: "뉴욕 합의 이혼 서류 준비 (한국어)",
  description:
    "뉴욕에서 변호사 없이 합의 이혼(무쟁점 이혼) 서류를 한국어로 준비하세요. AI가 단계별로 안내합니다. $500.",
  alternates: {
    canonical: "/ko/ny",
    ...
    <>
      <section className="relative overflow-hidden bg-gradient-to-b from-[#1a365d] via-[#1e3a5f] to-[#234876] pt-16 pb-24">
        ...
        <div className="relative mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl font-bold tracking-tight text-white sm:text-5xl lg:text-6xl">뉴욕 합의 이혼</h2>
          ...
          <p className="mt-6 text-lg text-zinc-300 max-w-2xl mx-auto">
            <span translate="no">DivorceGPT</span>가 뉴욕의 합의 이혼 서류를 단계별로 준비해 드립니다. 변호사 없이 진행하는 단순하고 다툼 없는 사건을 위한 도구입니다.
          </p>
          <p className="mt-4 text-sm text-zinc-400">$500 일회성 비용 · 숨겨진 비용 없음</p>
          <div className="mt-10">
            <Link href="/ny/qualify" className="inline-flex items-center gap-2 rounded-full bg-[#c59d5f] px-8 py-4 text-lg font-semibold text-white shadow-xl shadow-[#c59d5f]/30 transition-all hover:bg-[#d4ac6e] hover:-translate-y-0.5">
              자격 확인하고 시작하기 →
            </Link>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 space-y-6">
          <div className="rounded-2xl bg-amber-50 ring-1 ring-amber-200 p-6">
            ...
            <p className="mt-2 text-sm text-amber-800 leading-relaxed">
              자격 확인 절차는 현재 <strong>영어로 진행</strong>됩니다. 이후 서류 작성 단계에서는 AI 도우미가 <strong>한국어로</strong> 질문에 답하고 절차를 안내합니다. 모든 법원 제출 서류는 뉴욕주 법원의 요구에 따라 영어로 작성됩니다.
            </p>
          </div>
