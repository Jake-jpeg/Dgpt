...
const questions = [
  {
    id: "residency",
    question: "Has at least one spouse lived in Texas for at least 6 months?",
    description: "Texas requires at least one spouse to have been a domiciliary of Texas for 6 months before filing (Texas Family Code §6.301).",
    invertLogic: false,
  },
  {
    id: "countyResidency",
    question: "Has at least one spouse lived in the filing county for at least 90 days?",
    description: "You must file in the county where at least one spouse has resided for 90 days before filing.",
    invertLogic: false,
  },
  {
    id: "children",
  ...
  {
    id: "property",
    question: "Do you have real property (real estate) that needs to be divided?",
    description: "The Texas Supreme Court approved forms are for agreed divorces with no real property. If there is no real property to divide, you may qualify.",
    invertLogic: true,
  },
  {
    id: "support",
    question: "Is either spouse seeking spousal maintenance (alimony)?",
    description: "DivorceGPT only handles cases where neither party requests spousal maintenance.",
    invertLogic: true,
  },
  {
    id: "uncontested",
    question: "Do both spouses agree to the divorce and all terms?",
    description: "Both spouses must agree. The respondent will need to sign a Waiver of Citation to proceed without formal service.",
    invertLogic: false,
  },
  {
    id: "military",
  ...
  },
  {
    ...
    description: "This includes any protective orders (active or expired), family violence complaints, or police involvement for domestic incidents.",
    invertLogic: true,
  },
];

export default function TXQualifyPage() {
  ...
  const handleKeySubmit = async () => {
    ...
    try {
      const res = await fetch("/api/verify-access-key", {
        ...
        body: JSON.stringify({ key: accessKey.trim(), state: "tx" }),
      });
          ...
          <div className="flex h-16 items-center">
            <Link href="/tx" className="flex items-center gap-3 transition hover:opacity-80">
              ...
              <div>
                ...
                <p className="text-xs text-zinc-500">Texas Eligibility Check</p>
              </div>
            </Link>
          </div>
        </div>
      ...
      <main className="mx-auto max-w-2xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        {!keyVerified ? (
          <div className="text-center py-12">
            ...
            <h2 className="text-3xl font-bold tracking-tight text-zinc-900">Texas is Under Construction</h2>
            <p className="mt-2 text-zinc-600 max-w-md mx-auto">
              Texas document preparation is currently in development. Enter your access key to continue.
            </p>
          ...
          <>
            <div className="text-center mb-10">
              ...
              <p className="mt-2 text-zinc-600">
                Answer each question to see if DivorceGPT can prepare your Texas divorce documents.
              </p>
            </div>
          ...
          <div className="text-center py-12">
            ...
            <p className="mt-2 text-zinc-600 max-w-md mx-auto">
              Based on your answers, DivorceGPT can prepare your Texas divorce documents.
            </p>
            ...
            <div className="mt-8 rounded-2xl bg-white p-6 shadow-sm ring-1 ring-zinc-100 text-left">
              ...
              <p className="text-sm text-zinc-600 mb-4">
                DivorceGPT is a document preparation service. It uses the Texas Supreme Court approved forms for agreed divorces without children or real property.
              </p>
              ...
              <p className="text-sm text-zinc-600">
                Official divorce forms are available free from TexasLawHelp.org and through eFileTexas.gov.
              </p>
            </div>
          ...
          <div className="text-center py-12">
            ...
            <div className="mt-8 rounded-2xl bg-white p-6 shadow-sm ring-1 ring-zinc-100 text-left">
              ...
              <p className="text-sm text-zinc-600 mt-4">
                Texas has numerous military installations. We recommend contacting your base&apos;s legal assistance office or a family law attorney experienced in military divorces.
              </p>
            </div>
          ...
          <div className="text-center py-12">
            ...
            <p className="mt-6 text-sm text-zinc-500">
              We recommend consulting with a Texas family law attorney for assistance with your situation.
            </p>
