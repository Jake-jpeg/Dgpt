...
export const SHARED_ITEMS: IntakeItem[] = [
  ...
  q({ id: "shared.relationship.ceremony_type", section: "relationship", prompt: "Was the ceremony civil or religious?", type: "single_select", options: [ { value: "CIVIL", label: "Civil" }, { value: "RELIGIOUS", label: "Religious" } ], condition: { kind: "in", questionId: "shared.relationship.status_kind", values: ["MARRIAGE", "CIVIL_UNION"] }, helpTextByJurisdiction: { NY: "New York asks this because a religious ceremony can carry an extra step at the end of the case. Your attorney handles it." } }),
