...
export const SHARED_ITEMS: IntakeItem[] = [
  ...
  q({ id: "shared.relationship.marriage_place", section: "relationship", prompt: "City and country where the ceremony took place", type: "short_text", condition: { kind: "in", questionId: "shared.relationship.status_kind", values: ["MARRIAGE", "CIVIL_UNION", "DOMESTIC_PARTNERSHIP"] } }),
  ...
  q({ id: "shared.relationship.ceremony_type", section: "relationship", prompt: "Was the ceremony civil or religious?", type: "single_select", options: [ { value: "CIVIL", label: "Civil" }, { value: "RELIGIOUS", label: "Religious" } ], condition: { kind: "in", questionId: "shared.relationship.status_kind", values: ["MARRIAGE", "CIVIL_UNION"] } }),
  ...
  q({ id: "shared.relationship.prior_matrimonial_actions", section: "relationship", prompt: "Has either of you previously filed for divorce, separation, or annulment (against each other or anyone else)?", type: "yes_no", required: true }),
  ...
  q({ id: "shared.children.any", section: "children", prompt: "Do you and the other party have children together (including adopted or expected)?", type: "yes_no", required: true }),
  q({ id: "shared.children.records", section: "children", prompt: "For each child: name, date of birth, who they live with now, state, and school", type: "repeat_child", required: true, condition: { kind: "truthy", questionId: "shared.children.any" }, sensitive: true, documentIds: ["doc.school_records"] }),
